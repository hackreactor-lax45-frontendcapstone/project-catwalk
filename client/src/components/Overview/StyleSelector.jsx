    ...
    return (
      <div id="body-overview-styleselector">
        ...
        <button onClick={handleClick} className="btn-more-styles">{
          <svg id="up" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-compact-up" viewBox="0 0 16 16">
        ...
        <div className="style-thumbnails">
          ...
          <button onClick={handleClick} className="btn-more-styles">{
            <svg id="down" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-compact-down" viewBox="0 0 16 16">
